'''
给定一个只由 0（假）、1 (真)、&（逻辑与）、|（逻辑或）、^（s）五种字符组成的字符串 express，再给定一个布尔值 desired。
...
print(express01("1^0|0|1", True))
print(express01("1^0|0|1", False))
...
# print(express01_v2("0|1^0&1|1^0", True))
# print(express01_v2("0|1^0&1|1^0", True))
